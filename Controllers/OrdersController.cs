...
namespace sell_laptops.LMS.Controllers
{
    ...
    { 
        private readonly ILaptopssService _LaptopssService;
        private readonly IOrdersService _ordersService;

        private readonly ShoppingCart _ShoppingCart;
        
        public OrdersController(ILaptopssService LaptopssService, IOrdersService ordersService, ShoppingCart shoppingCart)
        {
            _LaptopssService = LaptopssService;
        ...
        {
            var item = await _LaptopssService.GetByID(id);
            if (item != null)
            {
